...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              color: isActive ? AppConstants.primaryBlue : AppConstants.cardColor,
              border: Border.all(
                color: isCurrent ? AppConstants.lightBlue : 
                       isActive ? AppConstants.primaryBlue : AppConstants.subtitleColor,
                width: 2,
              ),
            ),
            child: Center(
              child: isActive && !isCurrent
                ...
                : Text(
                    ...
                    style: GoogleFonts.poppins(
                      color: isActive ? Colors.white : AppConstants.subtitleColor,
                      fontSize: 14,
          ...
          Text(
            ...
            style: GoogleFonts.poppins(
              color: isCurrent ? AppConstants.lightBlue : 
                     isActive ? AppConstants.textColor : AppConstants.subtitleColor,
              fontSize: 10,
  ...
  Widget _buildStepLine(int step) {
    ...
    return Container(
      height: 2,
      width: 32,
      color: isActive ? AppConstants.primaryBlue : AppConstants.subtitleColor.withOpacity(0.3),
  ...
  void _handleVerifyCode() {
    ...
    if (enteredCode == _correctCode) {
      ...
      _showErrorDialog('Código incorrecto. Intenta de nuevo.\n(Código correcto: 1234)');
      _clearCodeFields();
    }
  }
